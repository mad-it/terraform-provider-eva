...
type UpdateCustomOrderStatusResponse struct {
}

func (c *Client) UpdateCustomOrderStatus(ctx context.Context, req UpdateCustomOrderStatusRequest) (*UpdateCustomOrderStatusResponse, error) {
	resp, err := c.restClient.R().
		SetBody(req).
	...
	var jsonResp UpdateCustomOrderStatusResponse
	if err := json.Unmarshal([]byte(resp.Body()), &jsonResp); err != nil {
...
type DeleteCustomOrderStatusResponse struct {
}

func (c *Client) DeleteCustomOrderStatus(ctx context.Context, req DeleteCustomOrderStatusRequest) (*DeleteCustomOrderStatusResponse, error) {
	resp, err := c.restClient.R().
		SetBody(req).
	...
	var jsonResp DeleteCustomOrderStatusResponse
	if err := json.Unmarshal([]byte(resp.Body()), &jsonResp); err != nil {
